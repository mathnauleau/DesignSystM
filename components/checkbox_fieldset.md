...
## Introduction
A **Checkbox fieldset** is a [brief description]. Use it to [primary purpose].

- Design: [🧬 Checkbox fieldset 1.3](link)
- Documentation: [link]
...
```html
<!-- HTML / Web example -->
<span class="checkbox-fieldset">Checkbox fieldset</span>
```