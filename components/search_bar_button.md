...
## Introduction
A **Search bar - Button** is a [brief description]. Use it to [primary purpose].

- Design: [🧬 Search bar - Button 1.3](link)
- Documentation: [link]
...
```html
<!-- HTML / Web example -->
<span class="search-bar---button">Search bar - Button</span>
```