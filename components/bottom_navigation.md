...
## Introduction
A **Bottom navigation** is a [brief description]. Use it to [primary purpose].

- Design: [🧬 Bottom navigation 1.3](link)
- Documentation: [link]
...
```html
<!-- HTML / Web example -->
<span class="bottom-navigation">Bottom navigation</span>
```