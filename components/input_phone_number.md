...
## Introduction
A **Input - Phone number** is a [brief description]. Use it to [primary purpose].

- Design: [🧬 Input - Phone number 1.3](link)
- Documentation: [link]
...
```html
<!-- HTML / Web example -->
<span class="input---phone-number">Input - Phone number</span>
```